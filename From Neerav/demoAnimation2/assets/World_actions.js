...
(function (flwebgl) {
	(function (actions) {
		actions.sc_Scene321_5_0 = function() {
		...
		actions.sc_Scene321_9_0 = function() {
		...
		actions.sc_Scene321_37_0 = function() {
			var stageInstance = this;
			stageInstance.global = stageInstance.global || {};
		...
		actions.sc_Scene321_60_0 = function() {
			var stageInstance = this;
			stageInstance.global = stageInstance.global || {};
		...
		actions.sc_Scene321_61_0 = function() {
			var stageInstance = this;
			stageInstance.global = stageInstance.global || {};
			stageInstance.global.characters = stageInstance.global.characters || [];
			
			stageInstance.global.getState = stageInstance.global.getState || function(character) {
				if(character.getCurrentLabel() == "move")
					return 0;
				else if(character.getCurrentLabel() == "descent")
					return 1;
				else if(character.getCurrentLabel() == "descent2")
					return 2;
				else if(character.getCurrentLabel() == "descent3")
					return 3;
				else if(character.getCurrentLabel() == "idle_end")
					return 4;
			}
			
			stageInstance.global.getLabel = stageInstance.global.getLabel || function(state) {
				switch(state) {
					case 0:
						return "move"
					case 1:
			...
			stageInstance.global.advanceTo = stageInstance.global.advanceTo || function(character, state) {
				if(state !== stageInstance.global.getState(character)) {
					character.gotoAndPlay(stageInstance.global.getLabel(state));
				}
			}
			
			stageInstance.global.characterDiscovered = stageInstance.global.characterDiscovered || function(character) {
			/*	//characterDiscovered function
				if(character is already added)
					return;
				add character;
				do animation;
				if(character count == 3)
					enable transit to scene 2;
				*/
				if(stageInstance.global.characters.indexOf(character) === -1)
					stageInstance.global.characters.push(character);
				var charactersLen = stageInstance.global.characters.length;
				var door_basket = stageInstance.getChildByName("door_basket");
				if(door_basket.getState() < charactersLen)
					door_basket.advanceTo(door_basket.getState() + 1);
				for(var characterItr = 0 ; characterItr < charactersLen; characterItr++) {
					var character = stageInstance.global.characters[characterItr];
					stageInstance.global.advanceTo(character, charactersLen);
				}
			}
		}
		actions.sc_Scene321_62_0 = function() {
			var stageInstance = this;
			stageInstance.global = stageInstance.global || {};
			stageInstance.global.enterFrameAttached = true;
		}
		actions.sc_Scene322_16_0 = function() {
			var stageInstance = this;
		...
		actions.mc_Light95Swing_1_0 = function() {
			this.stop();
		}
		...
		actions.mc_Wands47WandObject_0_87 = function() {
			var stageInstance = stageInstance || player.getStage();
			if(stageInstance.global.hitObject !== undefined && stageInstance.global.hitObject !== null) {
				if(stageInstance.global.hitObject.getName() === "c_firey" || stageInstance.global.hitObject.getName() === "c_fly_instance" || stageInstance.global.hitObject.getName() === "c_barrel") {
					stageInstance.global.hitObject.gotoAndPlay("move");
				}
			}
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Clouds47cloud952_1_1 = function() {
			var probability = Math.random()*100;
			if(probability<99.80){
				this.gotoAndPlay(1);
			}
			else
				this.gotoAndPlay(7);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Clouds47cloud952_1_94 = function() {
			this.gotoAndPlay(1);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Clouds47cloud952_1_95 = function() {
			this.gotoAndPlay(1);
		}
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Other95FG95Props47Fruit95with95Animation_2_0 = function() {
			this.stop()
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Other95FG95Props47Fruit95with95Animation_2_35 = function() {
			this.gotoAndPlay(2);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Other95FG95Props47Fruit95with95Animation_2_130 = function() {
			this.stop()
		}
		actions.mc_door95pulley47door95pulley47door95pulley95animation_10_0 = function() {
			this.getState = function() {
				if(this.getCurrentLabel() == "closed_door")
					return 0;
				else if(this.getCurrentLabel() == "open_door_anim1")
					return 1;
				else if(this.getCurrentLabel() == "open_door_anim2")
					return 2;
				else if(this.getCurrentLabel() == "open_door_anim3")
					return 3;
				else if(this.getCurrentLabel() == "opened_door")
					return 4;
			}
			...
			this.getLabel = function(state) {
				switch(state) {
					case 1:
						return "open_door_anim1"
					case 2:
						return "open_door_anim2"
					case 3:
						return "open_door_anim3"
					default:
						return "closed_door"
			...
			this.advanceTo = function(state) {
				if(state !== this.getState()) {
					this.gotoAndPlay(this.getLabel(state));
				}
			}
		}
		...
		actions.mc_door95pulley47door95pulley47door95pulley95animation_11_29 = function() {
			this.stop();
		}
		actions.mc_door95pulley47door95pulley47door95pulley95animation_11_37 = function() {
			this.stop();
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47Barrel95Character_0_0 = function() {
			this.stop();
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47Barrel95Character_0_1 = function() {
			var barrel1 = this.getChildByName("barrel1");
			barrel1.gotoAndPlay(1);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47Barrel95Character_0_147 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
			var c_barrel = stageInstance.getChildByName("c_barrel");
			stageInstance.global.characterDiscovered(c_barrel);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47Barrel95Character_0_155 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
			
			var door_basket = stageInstance.getChildByName("door_basket");
			if(door_basket.getState() <= 1) {
				this.stop();
			}
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47Barrel95Character_0_162 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
			
			var door_basket = stageInstance.getChildByName("door_basket");
			if(door_basket.getState() <= 2) {
				this.stop();
			}
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47Barrel95Character_0_170 = function() {
			this.stop();
			
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47ChracterTransform_7_0 = function() {
			this.stop()
		}
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95Firey_0_37 = function() {
			var stageInstance = stageInstance || player.getStage();
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95Firey_0_112 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
			var c_firey = stageInstance.getChildByName("c_firey");
			stageInstance.global.characterDiscovered(c_firey);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95Firey_0_120 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95Firey_0_127 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95fly_0_0 = function() {
			var fly_instance = this.getChildByName("c_fly_impl_instance");
			fly_instance.stop();
			this.stop();
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95fly_0_1 = function() {
			var fly_instance = this.getChildByName("c_fly_impl_instance");
			fly_instance.gotoAndPlay(2);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95fly_0_278 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
			var c_fly_instance = stageInstance.getChildByName("c_fly_instance");
			stageInstance.global.characterDiscovered(c_fly_instance);
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95fly_0_287 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95fly_0_296 = function() {
			var stageInstance = player.getStage();
			stageInstance.global = stageInstance.global || {};
		...
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47c95fly_0_331 = function() {
			this.gotoAndPlay("idle_end");
		}
		actions.mc_Color95BG9502c95Resized95Optimized46psd32Asset47Characters47fly95impl_2_331 = function() {
			this.gotoAndPlay(280);
		}
		actions.mc_959595Camera959595_0_0 = function() {
